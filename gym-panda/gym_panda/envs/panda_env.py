...
class PandaEnv(gym.Env):
    ...
    def __init__(self, headless, verbose=False, sparse_reward=False):
        ...
        scale_std = 7
        self.acs_mean = np.array([-0.534, -1.445, -0.422, -3.74, -0.39, 1.105, 1.142, 0.,
                                  0.])
        self.acs_std = np.array([1.808, 2.75, 0.979, 3.038, 0.733, 2.728, 2.882, 0.104, 0.104])
        self.obs_mean = np.array([0.015, 0., 0.005, 0., 0., 0.005, 0.021, 0.151,
                                  -0.471, 0.014, -0.529, -1.371, -0.411, -3.733, -0.206, 1.165,
                                  1.149, 0.007, 0., -0.349, -0.254, -0.026])
        self.obs_std = np.array([0.451, 0.259, 0.298, 0.251, 0.259, 0.299, 0.499, 0.76, 0.906,
